  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true);
        setImageUrls([]);
        setForm({ name: "", nameSi: "", categoryId: "", price: "", originalPrice: "", codAmount: "", codUnit: "per_unit", codUnitsPerKg: "", codAdditionalKgRate: "", stock: "0", unit: "piece", unitSi: "කැබැල්ල", certifications: [], description: "", descriptionSi: "" });
      } else {
